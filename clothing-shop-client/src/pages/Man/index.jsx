...
function Man() {
    return (
        <div className={`${styles["page-container"]}`}>
            <div className={`${styles["page-title"]} ${styles["title"]}`}>
                Nam
            </div>

            <div className="banner">
                <div className={`${styles["banner-event"]}`}>
                    <img src="https://im.uniqlo.com/global-cms/spa/res6b4eee428a8e71445abcd405b5162a72fr.jpg" alt="banner-event" />
                </div>
                <div className={`${styles["banner-event"]}`}>
                    <img src="https://im.uniqlo.com/global-cms/spa/res34b0a46b8007fa42e4e5f77ceb4742fbfr.jpg" alt="banner-event" />
                </div>
            </div>
                        ...
                        ManProduct.manCategories.map((category, index) => {
                            return (
                                <div className={`${styles["category-item"]}`}>
                                    <CategoryCard categoryImg={category.categoryImage} categoryTitle={category.categoryName} categoryUrl={category.categoryUrl} key={index} />
                                </div>
                            )
                        })
                    }
                        ...
                        ManProduct.manNews.map((news, index) => {
                            return (
                                <div className={`${styles["news-item"]}`}>
                                    <NewsCard newsImg={news.newsImage} newsTitle={news.newsTitle} newsDescription={news.newsDescription} newsUrl={news.newsUrl} key={index} />
                                </div>
                            )
                        })
                    }
                    ...
                    <div className={`${styles["special-product-container"]}`}>
                        <div className={`${styles["special-product-item"]}`}>
                            <SpecialProductCard
                                ...
                                specialDescription={ManProduct.manSpecialProduct[0].specialDescription}
