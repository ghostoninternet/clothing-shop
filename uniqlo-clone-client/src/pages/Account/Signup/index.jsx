        ...
        <div className="container" style={{ marginBottom: "88px" }}>
          ...
          <div className={cx("form-frame")}>
            <div className="auth-account-text" style={{ width: "81.25%" }}>
              Chúng tôi sẽ gửi thư xác nhận đến địa chỉ email được liên kết với
              tài khoản của bạn. Hãy kiểm tra email đến từ chúng tôi.
            </div>
            <form method="" action="/" onSubmit={handleSignUpFormSubmit}>
              ...
              <Input
                ...
                mgBottom="28px"
              ></Input>
              <div className={cx("heading")}>XÁC NHẬN ĐĂNG KÝ</div>
              <div
                style={{ marginBottom: "40px" }}
                className={cx("checkbox-input-frame")}
              >
                <input type="checkbox" className={cx("checkbox")} />
                <span className={cx("checkbox-input-text")}>
                  Thư điện tử UNIQLO
                </span>
              </div>
              <div
              ...
              <div style={{ marginTop: "20px" }} className="auth-account-text">
                ...
                liệu cá nhân của họ trong hệ thống. Thỏa thuận bên dưới sẽ giúp
                khách hàng lựa chọn việc có để cho dữ liệu cá nhân của mình được
                lưu trữ và xử lý vì mục đích cung cấp dịch vụ tương ứng. Vì mục
                đích của thỏa thuận bên dưới, sẽ gửi “tin nhắn văn bản”, nghĩa
                là thông báo cung cấp những thông tin quan trọng liên quan đến
              ...
              <div style={{ marginTop: "20px" }} className="auth-account-text">
                Tôi đồng ý cho phép Uniqlo sử dụng dữ liệu cá nhân của tôi để
                gửi cho tôi tin nhắn tiếp thị theo dạng tin nhắn văn bản không
                cá nhân hóa
              </div>
              <div
                style={{ marginBottom: "40px" }}
              ...
              <div style={{ marginTop: "20px" }} className="auth-account-text">
                Tôi đồng ý cho phép Uniqlo sử dụng dữ liệu cá nhân của tôi để
                gửi cho tôi tin nhắn tiếp thị theo dạng tin nhắn văn bản cá nhân
                hóa
              </div>
              <div
